...
SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM Products WHERE (ProductID = @ProductID)";
        ...
        public virtual int PDNameFillBy(NWDataSet.ProductsDataTable dataTable, string PdName) {
        ...
        public virtual NWDataSet.ProductsDataTable GetDataBy1(string PdName) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((PdName == null)) {
                throw new global::System.ArgumentNullException("PdName");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int UnitPriceFillBy(NWDataSet.ProductsDataTable dataTable, global::System.Nullable<decimal> Price1, global::System.Nullable<decimal> Price2) {
...
SELECT CustomerID, CompanyName, ContactName, ContactTitle, Address, City, Region, PostalCode, Country, Phone, Fax FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual NWDataSet.CustomersDataTable GetDataBy(string City) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((City == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
